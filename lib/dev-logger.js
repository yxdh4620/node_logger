...
(function() {
  var ERROR, FLUSH_INTERVAL, INFO, LEVELS, LOG, Logger, NAME_TAG, NOOP_FN, PID, ROTATION_INTERVAL, WARN, fs, logger, util;
    ...
    Logger.prototype._defineMethod = function(name) {
      ...
      if (this.isDebug) {
        return this[name] = function() {
          return console[name](PID, (new Date).toISOString(), tag, util.format.apply(null, arguments));
        };
      } else {
        return this[name] = function() {
          _this._cache[name].push("" + PID + " " + (new Date().toISOString()) + " " + tag + " " + (util.format.apply(null, arguments)) + "\r\n");
        };
      }
    };
